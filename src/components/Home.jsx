  ...
  return (
    <div className="container max-w-screen-xl py-20 leading 5">
      <h1 className="text-5xl mb-8 tracking light">
        Unlock <span className="font-extrabold">Innovation</span>, Shop Your
        Future Today!
      </h1>
      <div className="flex column gap-x-16 text-slate-600">
        <div>
          <p className="mb-5">
            Welcome to Famazon, your premier destination for cutting-edge tech
            and gadgets! Lorem ipsum dolor sit amet, consectetur adipiscing
            elit. Fusce fermentum ullamcorper libero, eu laoreet ligula iaculis
            sit amet. Proin euismod malesuada nisi, et convallis mauris faucibus
            et. Cras laoreet risus velit, eu sollicitudin est pharetra dapibus.
            Proin justo odio, finibus id quam eu, rutrum sagittis massa. Donec
            eu turpis massa. Proin in est eu enim semper cursus in eget dui.
          ...
          <p className="mb-5">
            Discover the future of tech at Famazon, where innovation meets
            convenience! Lorem ipsum dolor sit amet, consectetur adipiscing
            elit. Fusce fermentum ullamcorper libero, eu laoreet ligula iaculis
            sit amet. Proin euismod malesuada nisi, et convallis mauris faucibus
            et. Cras laoreet risus velit, eu sollicitudin est pharetra dapibus.
            Proin justo odio, finibus id quam eu, rutrum sagittis massa. Donec
