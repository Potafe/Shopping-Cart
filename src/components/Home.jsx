        ...
        <div className="container max-w-screen-xl flex items-center">
          <div className="w-1/2 max-w-full shrink-0">
            ...
            <p className="leading-5 max-w-prose">
              Step into the future with the revolutionary Banana headset. Experience
      ...
      <section className="container max-w-screen-xl flex items-center my-16">
        <div className="grow">
          ...
          <h2 className="text-5xl tracking-tight">
            BEST GAMING <span className="font-extrabold">PC'S.</span>
          </h2>
        ...
        <Link
          ...
          className="bg-black w-96 h-96 bg-[url(./src/assets/GAMING.png)] bg-center bg-[length:100%] bg-no-repeat transition-all duration-300 ease-in-out hover:bg-[length:120%]"
        />
      </section>

      <div className="container max-w-screen-xl py-20 leading-5">
        <h2 className="text-5xl mb-8 tracking-tight">
          Unlock <span className="font-extrabold">Innovation</span> Shop for the Future.
        </h2>
