...
const Cart = ({ onClose }) => {
    ...
    return (
        <>
            <div className={`z-10 fixed bg-slate-100 h-full max-w-xl w-full leading-5 py-16 px-20 right-0 ${transitionClasses} ${classes.cart}`}>
            ...
            <div className={`fixed w-full h-full ${transitionClasses} ${classes.background}`}
        onClick={handleCloseTransition}></div>
        </>
    )
