  ...
  useEffect(() => {
    (async () => {
      const response = await fetchData(
        `https://api.bestbuy.com/v1/products(sku=${id})?apiKey=PGbnJ286dtgKoN2oypkGpTep&format=json`,
      );
      ...
      <div className="max-w-prose">
        ...
        <div className="leading-tight text-sm mb-8 [&>p]:mb-3">
          ...
          <p>
            ...
            tincidunt quam orci, a luctus tortor auctor ut. Duis consequat
            tempus feugiat. Donec pretium, mauris id tincidunt hendrerit, urna
            velit tristique tellus, sed interdum orci eros quis dolor. Aliquam
            porta nec nunc vel viverra. Cras dapibus sagittis orci, et
            ullamcorper lacus tincidunt id. Praesent id enim est. Nullam
            suscipit erat at elit tempor mattis. Nulla ac tortor ultricies,
            posuere nibh quis, pellentesque orci.
          </p>
          ...
          <p>
            ...
            sagittis. Nunc commodo nibh eget condimentum iaculis. Ut erat massa,
            gravida eget urna sit amet, tristique posuere erat. Aliquam eu
            mollis massa. Proin venenatis lectus vitae scelerisque dapibus. Duis
            auctor lectus id nisi viverra congue. Curabitur et semper purus.
            Cras vel lacus sit amet nulla rutrum venenatis et vel nunc.
