            ...
            {items.map((item) => (
              <li key={item.id} className="flex gap-8 mb-8">
                ...
                <div className="flex flex-col gap-y-2 items-start">
                  ...
                  <div>
                    <button type="button" className="p-3 font-bold text-xl" onClick={() => onAdjustQuant(item.id, item.quantity, "decrement") }> - </button>
                    <span className="text-lg p-3">{item.quantity}</span>
                    <button type="button" className="p-3 font-bold text-xl" onClick={() => onAdjustQuant(item.id, item.quantity, "increment") }> + </button>
                  </div>
